...
description: 'Forks a skill from a URL (Anthropic, OpenAI, Hermes, or any repo) into .claude/skills/ — evaluates fit with the project, strips dead weight, applies project conventions, stamps provenance, and checks the trigger before writing.'
